...
const Support = () => {
    const menuItems = [
      { text: 'FAQs', icon: 'weixin' },
      { text: 'Report a Problem', icon: 'exclamation-circle' },
      { text: 'Issue History', icon: 'history' },
    ];
        ...
        <View style={styles.contact}>
          ...
          <View style={styles.contactItem}>
            ...
            <View>
              ...
              <Text style={styles.lightText}>utec.care@adityabirla.com  
              <Icon name="copy" size={10} color="#000000" style={{ marginLeft: 5 }} /> </Text>
