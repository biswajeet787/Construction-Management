    ...
    <ScrollView contentContainerStyle={styles.scrollViewContent}>
      <View style={styles.container}>
        ...
        <View style={styles.textContainer}>
          ...
          <View>
            <View style={styles.dropdownSection}>
              <Text style={styles.Title}>What is a Advance Concept design package</Text>
          ...
          <View style={styles.dropdownSection}>
            <Text style={[styles.Title1, styles.textWithGap]}>
              How do I avail a Advance Concept design {'\n'} package ?
            </Text>
            <TouchableOpacity onPress={() => console.log('clicked')}>
              <Icon name="down" size={20} color="#5B0888" />
            </TouchableOpacity>
          ...
          <View style={styles.dropdownSection}>
            <Text style={[styles.Title3, styles.textWithGap]}>
              What will be delivered as part of Advance concept design package?
            </Text>
            <TouchableOpacity onPress={() => console.log('clicked')}>
              <Icon name="down" size={20} color="#5B0888" />
            </TouchableOpacity>
          ...
          <View style={styles.dropdownSection}>
            <Text style={[styles.Title5, styles.textWithGap]}>
              {' '}
              What is the cost of availing a {'\n'}Advance Concept design  package?
            </Text>
            <TouchableOpacity onPress={() => console.log('clicked')}>
              <Icon name="down" size={20} color="#5B0888" />
            </TouchableOpacity>
